...
#define LAYER_NAVIGATION                                                                                 \
         KC_PGUP, KC_HOME, KC_UP,   KC_END,  ___x___,       ___x___, KC_APP,  KC_INS,  ___x___, FUNC,    \
         KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, ___x___,       KC_BSPC, _SCAG_MODS________________________, \
         _UCCPR_L___________________________________,       KC_DEL,  ___x___, KC_VOLD, KC_VOLU, KC_MUTE, \
...
#define LAYER_NUMBER                                                                                     \
         ...
         _UCCPR_L___________________________________,       KC_MINS, KC_1,    KC_2,    KC_3,    ___x___, \
_NONE_3__________________, _LYR_LTRANS______________,       KC_0,    _______,                   ___x___, \
                                             ___x___,       ___x___


#define LAYER_SYMBOL                                                                                     \
         KC_CIRC, KC_AMPR, KC_AT,   KC_DLR,  ___x___,       ___x___, KC_HASH, KC_ASTR, KC_PLUS, BK_DQUO, \
         KC_PERC, BK_LCBR, KC_RCBR, DT_PIPE, KC_SCLN,       KC_COLN, KC_EQL,  BK_LBRC, KC_RBRC, BK_SQUO, \
         ___x___, BK_LABK, KC_RABK, DT_BSLS, KC_GRV,        KC_TILD, DT_SLSH, BK_LPRN, KC_RPRN, ___x___, \
_NONE_3__________________, _LYR_LTRANS______________,       _LYR_RTRANS_____,                   ___x___, \
                                             ___x___,       ___x___


#define LAYER_FUNCTION                                                                                   \
         QK_BOOT, ___x___, GU_TOGG, CG_TOGG, DM_REC1,       KC_PSCR, KC_BRK,  ___x___, _______, _______, \
